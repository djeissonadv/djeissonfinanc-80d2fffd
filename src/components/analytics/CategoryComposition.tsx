        ...
        {top.map((s) => {
          ...
          return (
            <Wrapper
              ...
              className={`block w-full text-left space-y-1.5 ${drillDownMes ? 'cursor-pointer hover:bg-muted/40 rounded-md -mx-2 px-2 py-1 transition-colors' : ''}`}
              aria-label={drillDownMes ? `Ver transações de ${s.categoria} em ${drillDownMes}` : undefined}
            >
